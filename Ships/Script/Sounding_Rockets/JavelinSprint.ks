...
Wait 20.
// Set sv_anglePitchover to 70.//flight pitch
// Wait 20.
// Set sv_anglePitchover to 67.//flight pitch
// Wait 20.
// Set sv_anglePitchover to 60.//flight pitch
Until SHIP:Q < 0.15{
	Wait 0.2.
}
Stage. // realese fairings
// Set sv_anglePitchover to 40.//flight pitch (40 870km, 20 610km) //A-9 (40 858km, 20 780km)
wait 10.
unlock steering.
sas on.
Print (TIME:SECONDS - EngineStartTime).
//until (TIME:SECONDS - EngineStartTime) > 97{ // used for A-9
//	wait 0.5.
//}
