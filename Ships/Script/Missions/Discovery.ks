...
local box_MoonEND is wndw:addhlayout().
	...
	local MoonENDvalue is box_MoonEND:ADDTEXTFIELD("475").
...
If endheight > 450000 {
	...
	Stage.
	Wait 5.
	Shutdown. //sutdown for earth orbits
}
...
local startTime is time:seconds + nextnode:eta - (ff_Burn_Time(nextnode:deltaV:mag/ 2, 291, 71, 1)).
